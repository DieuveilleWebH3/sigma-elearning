!function(a,b,c,d)
{
    ...
    var f="editable",g={keyboard:!0,dblclick:!0,button:!0,buttonSelector:".edit",maintainWidth:!0,dropdowns:{},edit:function(){},save:function(){},cancel:function(){}};
    e.prototype={
        init:function(){
        ...
        edit:function(){
            ...
            a("td[data-field]",this.element).each(function(){
                var d,e=a(this).data("field"),f=a(this).text(),g=a(this).width();
                if(c[e]=f,a(this).empty(),b.options.maintainWidth&&a(this).width(g),e in b.options.dropdowns){d=a("<select></select>");
        ...
        },_captureEvent:function(a){a.stopPropagation()},_captureKey:function(a){
            13===a.which?(this.editing=!1,this.save()):27===a.which&&(this.editing=!1,this.cancel())}
        },a.fn[f]=function(b){return this.each(function(){
